jQuery(function( $ ) {
    ...
    wp.customize( 'waa_link_hover_color', function( value ) {
        value.bind( function( to ) {
            $( '.site-header .cart-area-top a:hover, .site-footer .footer-copy a:hover, a:hover' ).css( 'color', to );
        } );
    });

    wp.customize( 'waa_header_bg', function( value ) {
        value.bind( function( to ) {
            $( '.site-header' ).css( 'background-color', to );
        } );
    });

    wp.customize( 'waa_nav_bg', function( value ) {
        value.bind( function( to ) {
            $( '.navbar-default' ).css( 'background-color', to );
        } );
    });

    wp.customize( 'waa_nav_color', function( value ) {
        value.bind( function( to ) {
            $( '.navbar-default .navbar-nav > li > a' ).css( 'color', to );
        } );
    });

    wp.customize( 'waa_nav_hover', function( value ) {
        value.bind( function( to ) {
    ...
    wp.customize( 'waa_sidebar_widget_link', function( value ) {
        value.bind( function( to ) {
            $( '.widget ul li a' ).css( 'color', to );
        } );
    });

    wp.customize( 'waa_sidebar_link_hover', function( value ) {
        value.bind( function( to ) {
    ...
    wp.customize( 'waa_footer_widget_link', function( value ) {
        value.bind( function( to ) {
            $( '.site-footer .widget ul li a' ).css( 'color', to );
        } );
    });

    wp.customize( 'waa_footer_link_hover', function( value ) {
        value.bind( function( to ) {
            $( '.site-footer .widget ul li a:hover' ).css( 'color', to );
        } );
    });

    wp.customize( 'waa_footer_text', function( value ) {
        value.bind( function( to ) {
    ...
    wp.customize( 'waa_footer_bg', function( value ) {
        value.bind( function( to ) {
            $( '.site-footer .footer-widget-area' ).css( 'background', to );
        } );
    });

    wp.customize( 'waa_footer_bottom_bar_bg_color', function( value ) {
        value.bind( function( to ) {
