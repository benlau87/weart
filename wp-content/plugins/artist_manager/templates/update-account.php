...
<form method="post" action="">
    ...
    <div class="waa-become-seller">
        ...
        <p class="form-row form-group form-row-wide">
            <label for="seller-address"><?php _e( 'Address', 'waa' ); ?><span class="required">*</span></label>
        ...
        <input type="submit" class="waa-btn waa-btn-default" name="waa_migration" value="<?php _e( 'Become a Seller', 'waa' ); ?>" />
        </p>
    </div>
</form>
