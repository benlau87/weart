<div class="order_download_permissions wc-metaboxes-wrapper">
    ...
    <div class="toolbar row waa-clearfix">

        <div class="waa-w8">

            <select name="grant_access_id" class="grant_access_id waa-form-control" data-placeholder="<?php _e( 'Choose a downloadable product&hellip;', 'waa' ) ?>" multiple="multiple">
                <?php
        ...
        <div class="waa-w4">
            <button type="button" class="waa-btn waa-btn-success grant_access" data-order-id="<?php echo $order->id; ?>" data-nonce="<?php echo wp_create_nonce( 'grant-access' ); ?>"><?php _e( 'Grant Access', 'waa' ); ?></button>
        </div>
