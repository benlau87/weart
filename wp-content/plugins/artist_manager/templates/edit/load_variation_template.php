...
<div class="hide_if_no_variation">
    <table class="waa-table waa-variations-table">
        ...
        foreach (array_slice($variations, 1) as $variation) {
            ...
            $_regular_price = waa_get_woocs_int_price_reverse($variation_data['_regular_price'][0], true);
        ...
        ?>
        <tr>
            <td colspan="4"><a href="#variation-edit-popup" data-post_id='<?php echo $post_id ?>'
                               class="waa-btn waa_add_new_variation waa-btn-theme"><i class="ui ui-plus"></i>
                    &nbsp; <?php _e('Add New Variation', 'waa'); ?></a></td>
        </tr>
        </tbody>
    </table>

    <div class="waa-variation-action-wrapper">
        <a href="#doakn-single-attribute-wrapper" data-effect="mfp-zoom-out"
           data-product_attributes='<?php echo json_encode($modified_attribute); ?>'
           data-predefined_attr='<?php echo json_encode($attribute_taxonomies); ?>'
           class="waa-btn waa_add_new_attribute waa-btn-theme waa-right"><i class="ui ui-gear"></i>
            &nbsp;<?php _e('Add Options', 'waa'); ?></a>
