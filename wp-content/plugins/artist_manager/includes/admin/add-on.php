<div class="wrap">
    <h2><?php _e( 'waa - Add-ons', 'waa' ); ?></h2>

    <?php
    $add_ons = get_transient( 'waa_addons' );

    if ( false === $add_ons ) {
        $response = wp_remote_get( 'http://www.weare-art.com/api/waa/addons.php', array('timeout' => 15) );
        ...
        set_transient( 'waa_addons', $add_ons, 12 * HOUR_IN_SECONDS );
    }
