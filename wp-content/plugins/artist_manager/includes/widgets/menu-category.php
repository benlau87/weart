 ...
 */
class waa_Category_Walker extends Walker {
...
if ( ! class_exists( 'waa_Category_Widget' ) ) :
 ...
 */
class waa_Category_Widget extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 'classname' => 'waa-category-menu', 'description' => __( 'waa product category menu', 'waa' ) );
        $this->WP_Widget( 'waa-category-menu', 'waa: Product Category', $widget_ops );
    }
    ...
    function widget( $args, $instance ) {
        ...
        ?>
            <div id="cat-drop-stack">
                <?php
                $args = apply_filters( 'waa_category_widget', array(
                    'hide_empty' => false,
                    'orderby' => 'name',
                    'depth' => 3
                ) );
                ...
                $walker = new waa_Category_Walker();
                echo "<ul>";
...
add_action( 'widgets_init', create_function( '', "register_widget( 'waa_Category_Widget' );" ) );
