...
class Dokan_Admin_Settings {
    ...
    function admin_menu() {
        ...
        $dashboard = add_menu_page( __( 'Künstler Manager', 'dokan' ), __( 'Künstler Manager', 'dokan' ), $capability, 'dokan', array($this, 'dashboard'), 'dashicons-vault', $menu_position );
        add_submenu_page( 'dokan', __( 'Dashboard', 'dokan' ), __( 'Dashboard', 'dokan' ), $capability, 'dokan', array($this, 'dashboard') );
