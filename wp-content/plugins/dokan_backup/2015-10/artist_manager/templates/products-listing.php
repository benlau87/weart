            ...
            <article class="dokan-product-listing-area">
                <div class="product-listing-top dokan-clearfix">
                    ...
                    <span class="dokan-add-product-link">
                        <a href="<?php echo dokan_get_navigation_url( 'new-product' ); ?>" class="dokan-btn dokan-btn-theme dokan-right"><i class="ui ui-briefcase">&nbsp;</i> <?php _e( 'Add new product', 'dokan' ); ?></a>
                    </span>
                </div>
