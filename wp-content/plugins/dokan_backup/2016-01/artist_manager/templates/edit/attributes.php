<h4><?php _e( 'Attributes', 'waa' ); ?> <small><?php _e( 'Different types of this product (e.g. size, color)', 'waa' ); ?></small></h4>
            ...
            <div class="inputs-box woocommerce_attribute" data-count="<?php echo $i; ?>">
                ...
                <div class="box-header">
                    ...
                    <?php } else { ?>
                        ...
                        <input type="text" class="category-name" placeholder="<?php esc_attr_e( 'Category name', 'waa' ); ?>" name="attribute_names[<?php echo $i; ?>]" value="<?php echo esc_attr( $attribute_name ); ?>">
                ...
                <div class="box-inside waa-clearfix">
                        ...
                        <ul class="option-couplet list-unstyled ">
                            ...
                            if ($options) {
                                foreach ($options as $count => $option) {
                                    ...
                                    <li>
                                        <input type="text" class="option" placeholder="<?php _e( 'Option...', 'waa' ); ?>" name="attribute_values[<?php echo $i; ?>][<?php echo $count; ?>]" value="<?php echo esc_attr( $option ); ?>">
...
<p class="toolbar pull-right">
    ...
    <select class="select-attribute form-control" name="category_names" >
        <option value=""><?php _e( 'Custom Attribute', 'waa' ); ?></option>
        <?php
    ...
    <button class="btn btn-success add-variant-category"><?php _e( '+ Add a category', 'waa' ); ?></button>
    <button type="button" class="btn btn-default save_attributes" data-id="<?php echo $thepostid; ?>"><?php _e( 'Save attributes', 'waa' ); ?></button>
</p>