...
<?php do_action('wpo_wcpdf_before_order_details', $wpo_wcpdf->export->template_type, $wpo_wcpdf->export->order); ?>
		...
		<table class="order-details">
				...
				if (sizeof($items) > 0) : foreach ($items as $item_id => $item) : ?>
						<tr
							class="<?php echo apply_filters('wpo_wcpdf_item_row_class', $item_id, $wpo_wcpdf->export->template_type, $wpo_wcpdf->export->order, $item_id); ?>">
								<td class="product">
										...
										<dl class="meta">
												...
												<?php if (!empty($item['weight'])) : ?>
														...
														<dd
															class="weight"><?php echo $item['weight']; ?><?php echo get_option('woocommerce_weight_unit'); ?></dd><?php endif; ?>
										</dl>
						...
						<td class="no-borders" colspan="2">
								<table class="totals">
										...
										<?php endforeach; ?>
																				...
																				<?php
																				#print_r($wpo_wcpdf->get_order_grand_total('excl')); ?>
										</tfoot>
								</table>
						</td>
				</tr>
