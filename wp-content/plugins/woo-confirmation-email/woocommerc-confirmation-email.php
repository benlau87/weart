...
class woocommerce_confirmation_email {
    ...
    public function activate_plugins_wc_email() {
        ...
        update_option("wc_email_conf_title", __('Bitte bestätige dein Benutzerkonto bei WeArt.', 'waa'));
    }
    ...
    public function codeMailSender($email) {
        ...
        $Email_title = __('Bitte bestätige dein Benutzerkonto bei WeArt', 'waa');
        ...
        $preMesaage = '<html><body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">' . apply_filters('the_content', $message) . "<div style='clear:both'></div></div></body></html>";
        //global $email
    ...
    function please_confirm_email_message() {
        ...
        <ul class="woocommerce-info">
            <li><strong><?= __('E-Mail bestätigen', 'waa'); ?></strong>: <?= __('Dein Konto wurde noch nicht bestätigt. Bitte überprüfe dein E-Mail-Konto.', 'waa'); ?> <a style='font-size:14px;color:red 'href="<?php echo $link ?>"><?= __('Bestätigungsmail erneut senden', 'waa'); ?></a></li>
        </ul>
        <?php
    }
    ...
    function please_login_email_message() {
        ?>
        <ul class="woocommerce-info">
            <li><strong><?= __('Du hast dein Konto erfolgreich bestätigt.', 'waa'); ?></strong> <?= __('Du kannst dich nun einloggen.', 'waa'); ?></li>
        </ul>
        <?php
    }
    ...
    public function wc_email_verification_code() {
        ...
        $link = "<a href='" . $hyperlink . "'>Benutzerkonto aktivieren</a>";
        return $link;
