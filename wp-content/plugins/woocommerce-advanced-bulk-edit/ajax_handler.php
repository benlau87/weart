			...
			foreach($custsearchparam as $custitem)
			{
				if(isset($custitem['type']) && ($custitem['type'] !== 'custom' || $custitem['type'] !== 'customh'))
				{
					if($custitem['id'] == "ID" || $custitem['id'] == "_stock" || $custitem['id'] == "_stock_status")
					{
						...
						if($custitem['id'] == "ID")
						{
							$shortdesclike = " AND {$posts}.ID LIKE '".$custitem['value']."' ";
							continue;
						}
...
//									if($filename != "")
				...
				}else if($val->meta_key == '_stock_status'){
...
//						$val->meta_value = "";
					...
					else
					{
						...
						{
							if(isset($tax_classes[$val->meta_value]))
							{
								$obj->_tax_class = $tax_classes[$val->meta_value];
							}
						}else
						{
