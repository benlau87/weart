...
function waa_registration_form_fields($type)
{
    ...
    <div class="info-box danger waa_js_errors">
        <h4><?= __('Bitte füllen Sie alle Felder korrekt aus.', 'waa') . '</h4>'; ?>
            <span class="error"><strong><?= __('Fehler', 'waa'); ?></strong>: <span
                    class="error-msg"></span></span><br/>
    </div>
    ...
    <form id="waa_registration_form" class="waa_form" action="" method="POST">
        <fieldset>
            <?php if ($type == "artist") : ?>
                ...
                <div class="form-group">
                    ...
                    <input name="waa_user_last" id="waa_user_last" class="required form-control" type="text"
                           value="<?= $_POST['waa_user_last']; ?>"/>
                </div>
            <?php endif; ?>
            <div class="form-group">
                <label for="waa_user_email"><?php _e('E-Mail', 'waa'); ?></label>
                <input name="<?= ($type == "artist" ? 'waa_user_email' : 'waa_user_login'); ?>" id="waa_user_email"
                       class="required form-control" type="email" value="
            ...
            <?php if ($type == "artist") : ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <select id="waa_user_month" name="waa_user_month" class="form-control required">
                                ...
                                <option
                                    value="01"<?= ($_POST['waa_user_month'] == '01' ? ' selected' : '') ?>><?php _e('Januar', 'waa'); ?></option>
                                <option
                                    value="02"<?= ($_POST['waa_user_month'] == '02' ? ' selected' : '') ?>><?php _e('Februar', 'waa'); ?></option>
                                <option
                                    value="03"<?= ($_POST['waa_user_month'] == '03' ? ' selected' : '') ?>><?php _e('März', 'waa'); ?></option>
                                <option
                                    value="04"<?= ($_POST['waa_user_month'] == '04' ? ' selected' : '') ?>><?php _e('April', 'waa'); ?></option>
                                <option
                                    value="05"<?= ($_POST['waa_user_month'] == '05' ? ' selected' : '') ?>><?php _e('Mai', 'waa'); ?></option>
                                <option
                                    value="06"<?= ($_POST['waa_user_month'] == '06' ? ' selected' : '') ?>><?php _e('Juni', 'waa'); ?></option>
                                <option
                                    value="07"<?= ($_POST['waa_user_month'] == '07' ? ' selected' : '') ?>><?php _e('Juli', 'waa'); ?></option>
                                <option
                                    value="08"<?= ($_POST['waa_user_month'] == '08' ? ' selected' : '') ?>><?php _e('August', 'waa'); ?></option>
                                <option
                                    value="09"<?= ($_POST['waa_user_month'] == '09' ? ' selected' : '') ?>><?php _e('September', 'waa'); ?></option>
                                <option
                                    value="10"<?= ($_POST['waa_user_month'] == '10' ? ' selected' : '') ?>><?php _e('Oktober', 'waa'); ?></option>
                                <option
                                    value="11"<?= ($_POST['waa_user_month'] == '11' ? ' selected' : '') ?>><?php _e('November', 'waa'); ?></option>
                                <option
                                    value="12"<?= ($_POST['waa_user_month'] == '12' ? ' selected' : '') ?>><?php _e('Dezember', 'waa'); ?></option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <select id="waa_user_day" name="waa_user_day" class="form-control required"
                                    autocomplete="off">
                                <option><?php _e('Tag', 'waa'); ?></option>
                                <option value="01"<?= ($_POST['waa_user_month'] == '01' ? ' selected' : '') ?>>1
                                </option>
                                <option value="02"<?= ($_POST['waa_user_month'] == '02' ? ' selected' : '') ?>>2
                                </option>
                                <option value="03"<?= ($_POST['waa_user_month'] == '03' ? ' selected' : '') ?>>3
                                </option>
                                <option value="04"<?= ($_POST['waa_user_month'] == '04' ? ' selected' : '') ?>>4
                                </option>
                                <option value="05"<?= ($_POST['waa_user_month'] == '05' ? ' selected' : '') ?>>5
                                </option>
                                <option value="06"<?= ($_POST['waa_user_month'] == '06' ? ' selected' : '') ?>>6
                                </option>
                                <option value="07"<?= ($_POST['waa_user_month'] == '07' ? ' selected' : '') ?>>7
                                </option>
                                <option value="08"<?= ($_POST['waa_user_month'] == '08' ? ' selected' : '') ?>>8
                                </option>
                                <option value="09"<?= ($_POST['waa_user_month'] == '09' ? ' selected' : '') ?>>9
                                </option>
                                <option value="10"<?= ($_POST['waa_user_month'] == '10' ? ' selected' : '') ?>>10
                                </option>
                                <option value="11"<?= ($_POST['waa_user_month'] == '11' ? ' selected' : '') ?>>11
                                </option>
                                <option value="12"<?= ($_POST['waa_user_month'] == '12' ? ' selected' : '') ?>>12
                                </option>
                                <option value="13"<?= ($_POST['waa_user_month'] == '13' ? ' selected' : '') ?>>13
                                </option>
                                <option value="14"<?= ($_POST['waa_user_month'] == '14' ? ' selected' : '') ?>>14
                                </option>
                                <option value="15"<?= ($_POST['waa_user_month'] == '15' ? ' selected' : '') ?>>15
                                </option>
                                <option value="16"<?= ($_POST['waa_user_month'] == '16' ? ' selected' : '') ?>>16
                                </option>
                                <option value="17"<?= ($_POST['waa_user_month'] == '17' ? ' selected' : '') ?>>17
                                </option>
                                <option value="18"<?= ($_POST['waa_user_month'] == '18' ? ' selected' : '') ?>>18
                                </option>
                                <option value="19"<?= ($_POST['waa_user_month'] == '19' ? ' selected' : '') ?>>19
                                </option>
                                <option value="20"<?= ($_POST['waa_user_month'] == '20' ? ' selected' : '') ?>>20
                                </option>
                                <option value="21<?= ($_POST['waa_user_month'] == '21' ? ' selected' : '') ?>">21
                                </option>
                                <option value="22"<?= ($_POST['waa_user_month'] == '22' ? ' selected' : '') ?>>22
                                </option>
                                <option value="23"<?= ($_POST['waa_user_month'] == '23' ? ' selected' : '') ?>>23
                                </option>
                                <option value="24"<?= ($_POST['waa_user_month'] == '24' ? ' selected' : '') ?>>24
                                </option>
                                <option value="25"<?= ($_POST['waa_user_month'] == '25' ? ' selected' : '') ?>>25
                                </option>
                                <option value="26"<?= ($_POST['waa_user_month'] == '26' ? ' selected' : '') ?>>26
                                </option>
                                <option value="27"<?= ($_POST['waa_user_month'] == '27' ? ' selected' : '') ?>>27
                                </option>
                                <option value="28"<?= ($_POST['waa_user_month'] == '28' ? ' selected' : '') ?>>28
                                </option>
                                <option value="29"<?= ($_POST['waa_user_month'] == '29' ? ' selected' : '') ?>>29
                                </option>
                                <option value="30"<?= ($_POST['waa_user_month'] == '30' ? ' selected' : '') ?>>30
                                </option>
                                <option value="31"<?= ($_POST['waa_user_month'] == '31' ? ' selected' : '') ?>>31
                                </option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <input name="waa_user_year" id="waa_user_year" placeholder="Year"
                                   class="required form-control" type="text" value="<?= $_POST['waa_user_year']; ?>"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    woocommerce_form_field('waa_user_country', array(
                            ...
                            'options' => $countries,
                            'placeholder' => __('Bitte wählen', 'waa')
                        )
                    );
                    ?>
                </div>
                ...
                <div class="form-group register_form_user">
                    ...
                    <input name="waa_user_login" id="waa_user_login" class="required form-control" type="text"
                           value="<?= $_POST['waa_user_login']; ?>" data-toggle="tooltip" data-placement="top"
                           title="keine Sonderzeichen oder Leerzeichen erlaubt"/>

                    <div
                        class="help-block text-muted"><?php _e('Wichtig: Der Benutzername darf keine Sonderzeichen oder Leerzeichen beinhalten. Ihr Benutzername wir für Ihr Benutzerprofil genutzt, z.B. www.weart.com/kuenstler/ihr-name', 'waa'); ?></div>
                </div>
            <?php endif; ?>
            <div class="form-group">
                <label for="waa_user_pass"><?php _e('Passwort', 'waa'); ?></label>
                <input name="waa_user_pass" id="waa_user_pass" class="required form-control" type="password"
                       value="<?= $_POST['waa_user_pass']; ?>"/>
            ...
            <div class="form-group">
                ...
                <input name="waa_user_pass_confirm" id="waa_user_pass_confirm" class="required form-control"
                       type="password" value="<?= $_POST['waa_user_pass_confirm']; ?>"/>
            </div>
            <div class="checkbox">
                <label>
                    <input name="waa_user_legal" id="waa_user_legal" type="checkbox" value="1"
                           data-error-msg="<?php _e('Bitte akzeptieren Sie unsere Allgemeinen Geschäftsbedingungen.', 'waa') ?>"
                           class="required"<?= ($_POST['waa_user_legal'] == '1' ? ' checked="checked"' : '') ?>> <?php _e('AGBs akzeptieren.', 'waa'); ?>
                </label>
            </div>
            <div class="form-group">
                <input type="hidden" name="waa_register_nonce"
                       value="<?php echo wp_create_nonce('waa-register-nonce'); ?>"/>
