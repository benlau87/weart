...
function waa_load_scripts()
{
    ...
    wp_register_script('slider', get_template_directory_uri() . '/js/slider.min.js', array('jquery'), false, true);
    wp_enqueue_script('slider');

    wp_register_script('registration-script', get_template_directory_uri() . '/js/register.js', array('jquery'), false, true );

    $url = $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
    if(is_page( 256 ) || strpos('account-migration',$url) !== false ) wp_enqueue_script('registration-script');
}
