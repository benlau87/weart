...
jQuery(document).ready(function($){
	...
	$("#main-nav-mobile li.menu-item-has-children > ul > li").append('<i class="chevron right"></i>');
	...
	$('#main-nav-mobile form').on('click', function(e) {
		e.stopPropagation();
	});


	$('#main-nav-mobile li a, #nav-mobile ul li a').not('li.menu-item-has-children > a, li.last > a').click(function(e) {
		e.stopPropagation();
		$('#loading').show();
